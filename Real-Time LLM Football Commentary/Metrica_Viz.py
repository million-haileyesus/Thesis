...
def plot_pitch(field_dim=(106.0, 68.0), field_color='green', linewidth=2, markersize=20):
    """ plot_pitch
    ...
    Parameters
    -----------
        field_dim: (length, width) of field in meters. Default is (106,68)
    ...
    half_pitch_length = field_dim[0] / 2.  # length of half pitch
    half_pitch_width = field_dim[1] / 2.  # width of half pitch
    signs = [-1, 1]
    ...
    ax.set_yticks([])
    # set axis limits
    xmax = field_dim[0] / 2. + border_dimen[0]
    ymax = field_dim[1] / 2. + border_dimen[1]
